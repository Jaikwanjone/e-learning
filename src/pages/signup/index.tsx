...
const SignUpPage = () => {
  const [selectedId, setSeletcedId] = useState<number>(2);
  const SelectedTesti = Testimonal.filter((item) => item.id === selectedId);
  useEffect(() => {}, [selectedId]);

  return (
    <div className="  container mx-auto mt-16 grid tablet:grid-flow-col iPad:grid-cols-5  desktop:gap-[6rem] gap-[3rem] ">
      <div className=" iPad:col-span-3 w-full grid gap-6">
      ...
      <div className=" iPad:col-span-2 w-full bg-white-1  rounded-md tablet:p-8 p-5">
        <div className="flex justify-center flex-col items-center gap-2">
          <h1 className="laptop:text-4xl text-3xl font-semibold">Sign Up</h1>
        ...
        <div className="grid gap-5">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              ...
              <label className=" text-grey-2">
                I agree with{" "}
                <span className=" underline text-lg text-grey-1">
                  Terms of Use
                </span>{" "}
                and{" "}
                <span className=" underline text-lg text-grey-1">
          ...
          <div className="flex justify-center ">
            ...
            <Link to="/login" className="text-lg font-medium underline">
              Log In
            </Link>
            <div>
              <img src={TopLeft} alt="" />
